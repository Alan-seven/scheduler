...
public interface StationTmRepository {
     ...
     * @return
     */
    @Select("SELECT id,stcd,tm FROM station_tm a WHERE tm >= #{startDate} AND tm < #{endDate} and  EXISTS (select b.stcd from wr_stat_b b where b.st_tp='WQ' and a.stcd=b.stcd )")
